...
public class Carro extends Veiculo implements Acoes {
	...
	public Carro(String nome, String cor, String placa, int ano, boolean status, int CapacidadeTanque,
			int SituacaoTanque) {
	...
	public void Acelerar() {
		if (isStatus() == false) {
			...
			if (getSituacaoTanque() > 0) {
				...
				setSituacaoTanque(getSituacaoTanque() - 10);
			} else {
	...
	public void TrocarPneu() {
		System.out.println("Pneu do carro trocado.");
